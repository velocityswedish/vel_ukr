# 🇺🇦 Velocity Ukrainian - Automated Facebook Reels Bot

**Automated Ukrainian learning content generator for social media**

Generates and posts 4x daily to Facebook, Instagram, and other platforms with:
- ✅ AI-generated Ukrainian phrases with English translations
- ✅ Professional text-to-speech (Edge TTS)
- ✅ Beautiful gradient backgrounds with text overlays
- ✅ Perfect audio-video synchronization
- ✅ Velocity Ukrainian branding
...
4. Wisdom (Мудрість)
5. Happiness (Щастя)
6. Self Improvement (Саморозвиток)
7. Gratitude (Вдячність)
8. Friendship (Дружба)
9. Hope (Надія)
10. Creativity (Креативність)
11. Inner Peace (Внутрішній Спокій)
12. Confidence (Впевненість)
13. Perseverance (Наполегливість)
14. Inspiration (Натхнення)
15. Positive Life (Позитивне Життя)
16. Courage (Хоробрість)
17. Kindness (Доброта)
18. Patience (Терпіння)
19. Forgiveness (Прощення)
20. Strength (Сила)
21. Joy (Радість)
22. Balance (Баланс)
23. Growth (Зростання)
24. Purpose (Мета)
25. Mindfulness (Усвідомленість)
...
1. Go to Actions → "Velocity Ukrainian - Daily 4x Upload"
...
- **Frame Rate:** 30 FPS
- **Audio:** Edge TTS (GuyNeural EN, OstapNeural UK)
...
- English + 500ms pause + Ukrainian timing preserved
...
- Distinct colors: Navy (EN) / Yellow (UK) / Gray (Pronunciation)
- Velocity Ukrainian branding on every frame
...
**Made with ❤️ for Ukrainian learners worldwide**

🇺🇦 Learn Ukrainian with Velocity Ukrainian! 🇺🇦
